...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.image_file'
        db.add_column(u'arkiwimain_project', 'image_file',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.image_file'
        db.delete_column(u'arkiwimain_project', 'image_file')
